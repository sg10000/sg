...
namespace UnitTestProject
{
    ...
    public class LeftCommandTest
    {
        ...
        [TestMethod]
        public void North_NoPositionChange_ExpectFacingWest()
        {
            IToy toy = new Robot()
            {
                X = X_Position,
        ...
        [TestMethod]
        public void West_NoPositionChange_ExpectFacingSouth()
        {
            IToy toy = new Robot()
            {
                X = X_Position,
        ...
        [TestMethod]
        public void South_NoPositionChange_ExpectFacingEast()
        {
            IToy toy = new Robot()
            {
                X = X_Position,
        ...
        [TestMethod]
        public void East_NoPositionChange_ExpectFacingNorth()
        {
            IToy toy = new Robot()
            {
                X = X_Position,
